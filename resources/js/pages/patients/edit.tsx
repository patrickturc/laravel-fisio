                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-card/60 backdrop-blur-xl border border-border/50 rounded-2xl p-6 md:p-8 shadow-sm space-y-5">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input id="name" value={data.name} onChange={e => setData('name', e.target.value)} className="bg-background" required />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="rg" value={data.rg} onChange={e => setData('rg', e.target.value)} className="bg-background" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="grid gap-2">
                                ...
                                <Input id="profession" value={data.profession} onChange={e => setData('profession', e.target.value)} className="bg-background" />
                    ...
                    <div className="bg-card/60 backdrop-blur-xl border border-border/50 rounded-2xl p-6 md:p-8 shadow-sm space-y-5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div className="grid gap-2">
                                ...
                                <Input id="number" value={data.number} onChange={e => setData('number', e.target.value)} className="bg-background" />
                                <InputError message={errors.number} />
                            </div>
                            <div className="grid gap-2 md:col-span-2">
                                <Label htmlFor="complement">Complemento</Label>
                                <Input id="complement" value={data.complement} onChange={e => setData('complement', e.target.value)} className="bg-background" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div className="grid gap-2">
                                ...
                                <Input id="neighborhood" value={data.neighborhood} onChange={e => setData('neighborhood', e.target.value)} className="bg-background" />
                                <InputError message={errors.neighborhood} />
                            </div>
                            <div className="grid gap-2">
                                <Label htmlFor="city">Cidade</Label>
                                <Input id="city" value={data.city} onChange={e => setData('city', e.target.value)} className="bg-background" />
